...
class PuchaseReturnNotForSale extends StatefulWidget {
  const PuchaseReturnNotForSale  ({super.key});

  @override
  State<PuchaseReturnNotForSale  > createState() => _PurchaseInvoiceState();
}

class _PurchaseInvoiceState extends State<PuchaseReturnNotForSale  > {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Purchase Return Not Sale'),
