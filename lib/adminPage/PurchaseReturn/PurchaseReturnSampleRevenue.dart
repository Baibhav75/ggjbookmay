...
class PucchaseReturnSampleRevenue extends StatefulWidget {
  const PucchaseReturnSampleRevenue   ({super.key});

  @override
  State<PucchaseReturnSampleRevenue> createState() => _PurchaseInvoiceState();
}

class _PurchaseInvoiceState extends State<PucchaseReturnSampleRevenue > {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Purchase Return Sample Revenue'),
