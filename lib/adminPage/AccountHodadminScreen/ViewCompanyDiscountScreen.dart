...
class ViewCompanyDiscountScreen extends StatefulWidget {
  ...
  const ViewCompanyDiscountScreen({super.key, required this.billNo});

  @override
  State<ViewCompanyDiscountScreen> createState() =>
      _ViewCompanyDiscountScreenState();
}

class _ViewCompanyDiscountScreenState
    extends State<ViewCompanyDiscountScreen> {
  late Future<ViewCompanyDiscountModel> future;
  ...
  Widget invoiceHeader(ViewCompanyDiscountModel data) {
    return Column(
      children: [
        Row(
        ...
        const Text("Purchase Discount Apply Invoice",
  ...
  Map<String, List<ViewCompanyItem>> groupData(List<ViewCompanyItem> list) {
    final map = <String, List<ViewCompanyItem>>{};
