...
class samplesaleInvoice extends StatefulWidget {
  const samplesaleInvoice ({super.key});

  @override
  State<samplesaleInvoice > createState() => _saleInvoiceState();
}

class _saleInvoiceState extends State<samplesaleInvoice > {
