...
class Purchasesamplerevenew extends StatefulWidget {
  const Purchasesamplerevenew({super.key});

  @override
  State<Purchasesamplerevenew > createState() => _PurchasesamplerevenewState();
}

class _PurchasesamplerevenewState extends State<Purchasesamplerevenew > {
