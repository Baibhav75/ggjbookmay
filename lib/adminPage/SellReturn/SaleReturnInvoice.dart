...
class saleReturnInvoice extends StatefulWidget {
  const saleReturnInvoice({super.key});

  @override
  State<saleReturnInvoice> createState() => _saleReturnInvoiceState();
}

class _saleReturnInvoiceState extends State<saleReturnInvoice> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Sale Return Invoice'),
