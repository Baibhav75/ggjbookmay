...
class SampleSaleReturnInvoice extends StatefulWidget {
  const SampleSaleReturnInvoice({super.key});

  @override
  State<SampleSaleReturnInvoice> createState() => _SampleSaleReturnInvoiceState();
}

class _SampleSaleReturnInvoiceState extends State<SampleSaleReturnInvoice> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Sample Sale Return Invoice'),
