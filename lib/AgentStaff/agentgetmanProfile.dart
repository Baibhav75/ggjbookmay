...
class Agentgetmanprofile extends StatefulWidget {
  final String mobileNo;

  const Agentgetmanprofile({Key? key, required this.mobileNo}) : super(key: key);

  @override
  State<Agentgetmanprofile> createState() => _GetManProfilePageState();
}

class _GetManProfilePageState extends State<Agentgetmanprofile> {
